...
Este directorio contiene la documentación local del repositorio principal de OpenClaw en Windows.
...
1. [01_INSTALACION_WINDOWS.md](/C:/omi/openclaw/docs/01_INSTALACION_WINDOWS.md)
2. [02_ARQUITECTURA.md](/C:/omi/openclaw/docs/02_ARQUITECTURA.md)
3. [03_PROTOCOLO_OPERATIVO.md](/C:/omi/openclaw/docs/03_PROTOCOLO_OPERATIVO.md)
4. [05_TELEGRAM.md](/C:/omi/openclaw/docs/05_TELEGRAM.md)
...
- [03_PROTOCOLO_OPERATIVO.md](/C:/omi/openclaw/docs/03_PROTOCOLO_OPERATIVO.md)
...
## Documentos de apoyo existentes

Estos se conservan como documentos historicos de la fase inicial:
